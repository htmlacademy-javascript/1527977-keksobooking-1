...
// // ; Обратите внимание, разметка похожих объявлений в будущем будет вставляться прямо
// в интерактивную карту, а пока, на время разработки, мы её будем отображать в блоке,
// где должна быть карта.
...
// // ; Дворец для palace
// // ; Отель для hotel
// // ; Выведите количество гостей и комнат offer.rooms и offer.guests в блок
//  .popup__text--capacity строкой вида {{offer.rooms}} комнаты для {{offer.guests}} гостей.
//  Например, «2 комнаты для 3 гостей».
// // ; Время заезда и выезда offer.checkin и offer.checkout в блок .popup__text--time
// строкой вида Заезд после {{offer.checkin}}, выезд до {{offer.checkout}}. Например, «Заезд после 14:00, выезд до 14:00».
